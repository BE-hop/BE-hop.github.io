(() => {
  const topics = [
  {
    ...
    "excerpt": {
      "en": "The true leap in AI design is not drawing faster, but encoding why a decision is made into reusable cognition systems.",
      "zh": "AI 设计的真正跃迁，不在“画得更快”，而在把“为什么这样设计”的判断结构编码成可复用系统。"
    },
    "content": [
      {
        "type": "p",
        "zh": "我们常把“AI 做设计”理解为更快出图。但把设计拆成两个层级后会发现，真正分水岭不在“怎么画线”，而在“为什么画这条线”。"
      },
      {
        "type": "h2",
        "zh": "1）几何算法：解决“怎么画线”"
      ...
      {
        "type": "p",
        "zh": "几何算法关注形式生成的可执行性，核心是把动作转成规则、再把规则转成可运行算法。参数化、约束求解、程序化建模都属于这一层。"
      },
      {
        "type": "ul",
        "zh": [
          "参数化与程序化建模（Rhino / GH / 脚本）",
          "约束求解（constraints & solvers）",
          "形态生成与网格/曲面运算（mesh / NURBS）"
        ]
      },
      {
        "type": "p",
        "zh": "这一层本质上是效率革命：让设计动作标准化、可复用、可规模化。"
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "zh": "设计规则关注决策合理性与目标性，回答的是服务对象、目标优先级、取舍依据和系统关系。"
      },
      {
        "type": "ul",
        "zh": [
      ...
      {
        "type": "p",
        "zh": "如果说几何算法决定“能不能跑”，设计规则决定“跑向哪里、为什么跑、值不值得跑”。"
      },
      {
        "type": "h2",
        "zh": "3）AI 的关键战场在“设计规则层”"
      },
      {
        "type": "p",
        "zh": "仅提升生成质量并不足够。真正关键是 Design Cognition Encoding：把设计师的判断结构编码成可被 AI 理解、调用、组合和演化的认知系统。"
      },
      {
        "type": "ul",
        "zh": [
      ...
      {
        "type": "p",
        "zh": "几何算法层，AI 已经很强；设计规则层，才是决定未来主导权的分水岭。谁能把判断结构外化为规则系统，谁就能长期放大设计杠杆。"
      },
      {
        "type": "h2",
        "zh": "5）当下最现实路线：先做“增强型 AI 设计”"
      },
      {
        "type": "p",
        "zh": "即便终局可能是 AI 进入决策主体，当下更确定的路径仍是让 AI 成为设计师的效率外挂、表达外挂和推演外挂。"
      },
      {
        "type": "ul",
        "zh": [
          "把重复劳动交给 AI，提高交付效率",
          "把设计认知沉淀为 checklist、模板与流程",
          "把“个人经验”升级为“可复利的认知资产”"
        ]
      },
      {
      ...
      {
        "type": "p",
        "zh": "AI 时代真正稀缺的，不是“会画图”，而是“会判断并能编码判断”。未来不在画线速度，而在规则能力。"
      }
    ]
  },
  {
