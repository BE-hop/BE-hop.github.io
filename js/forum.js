(() => {
  const translations = {
    zh: {
      ...
      "forum.compose.title": "发布留言",
      "forum.compose.subtitle": "发布后将生成一个留言页面，其他人可以在该页面评论解答。",
      "forum.compose.label.name": "昵称",
      "forum.compose.label.location": "地点",
      "forum.compose.label.title": "留言标题",
      "forum.compose.label.message": "留言内容",
      "forum.compose.placeholder.name": "输入昵称（可选）",
      "forum.compose.placeholder.location": "城市/地区（可选）",
      "forum.compose.placeholder.title": "例如：请问如何入门 AI 景观设计？",
      "forum.compose.placeholder.message": "请输入你的问题、反馈或讨论内容...",
      "forum.compose.tag": "标签：留言",
      "forum.compose.note": "发布后会根据模板自动生成话题页。",
      "forum.compose.cancel": "取消",
      "forum.compose.submit": "发布留言",
    ...
    en: {
      ...
      "forum.actions.publish": "Post Message",
      ...
      "forum.compose.title": "Post A Message",
      "forum.compose.subtitle": "Publishing creates a topic page where others can reply and help.",
      "forum.compose.label.name": "Name",
      "forum.compose.label.location": "Location",
      "forum.compose.label.title": "Title",
      "forum.compose.label.message": "Message",
      "forum.compose.placeholder.name": "Enter your name (optional)",
      "forum.compose.placeholder.location": "City / Region (optional)",
      "forum.compose.placeholder.title": "Example: How do I start with AI landscape design?",
      "forum.compose.placeholder.message": "Write your question, feedback, or discussion...",
      "forum.compose.tag": "Tag: Message",
      "forum.compose.note": "A topic page is generated from this template after publishing.",
      "forum.compose.cancel": "Cancel",
      "forum.compose.submit": "Publish",
